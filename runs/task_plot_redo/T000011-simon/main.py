...
def run(options: TaskRunOptions):
    """Run Simon in human/qa/sim mode with one auditable flow."""
    task_root = Path(__file__).resolve().parent
    cfg = load_config(str(options.config_path))
    print(f"[SIMON] mode={options.mode} config={options.config_path}")
...
def main() -> None:
    ...
    options = parse_task_run_options(
        task_root=task_root,
        description="Run Simon in human/qa/sim mode.",
